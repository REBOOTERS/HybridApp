    ...
    render() {
        ...
        return (<View style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <ImageBackground style={styles.userInfobg} source={require('../images/live_player_bg.jpg')}>
                    <ImageBackground style={styles.avatar} source={{uri:'http://pic.jia360.com/ueditor/jsp/upload/201609/27/17601474946123480.png'}}/>
                    <View style={{flex: 1, marginRight: 10}}>
                        ...
                        <View style={{backgroundColor: 'white', height: 1, marginTop: 10, marginBottom: 10}}/>
                ...
                <Image style={{width:windowWidth,height:windowWidth*1.02,marginTop:10}}
                       resizeMode={'contain'} source={require('../images/fake.jpg')}/>
